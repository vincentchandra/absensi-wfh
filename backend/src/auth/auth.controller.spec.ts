...
describe('AuthController', () => {
  ...
  describe('changePassword', () => {
    it('should delegate to authService.changePassword with userId from request', async () => {
      const dto = { oldPassword: 'old', newPassword: 'New123abc', confirmPassword: 'New123abc' };
      const req = { user: { userId: 1 } };
      authService.changePassword!.mockResolvedValue({ message: 'Password berhasil diubah' });
